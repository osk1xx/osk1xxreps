...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OSK1XXREPS" },
      { name: "description", content: "OSK1XXREPS" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "OSK1XXREPS" },
      { property: "og:description", content: "OSK1XXREPS" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "OSK1XXREPS" },
      { name: "twitter:description", content: "OSK1XXREPS" },
